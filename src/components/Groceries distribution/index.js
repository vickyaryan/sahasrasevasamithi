...
function GroceriesDistribution () {
  return (
    <Container className="mt-2">
      <h3 className="text-center">Groceries Distribution</h3>
      <Swiper
        breakpoints={{
          "640": { 
            "slidesPerView": 2,
      ...
      >
        {data.groceries.images.slice(0,3).map((item,index)=>
...
export default GroceriesDistribution;
